    ...
    <div className="container">
          ...
          >
            ...
            {(() => {
              const filtrados = exercicios.filter(
                (ex) =>
                  ex.treino === (modalResumo.treinoIniciado || treinoAtivo),
              );
              if (filtrados.length === 0) return null;
              const dadosGrafico = filtrados.map((ex) => ({
                name:
                  ex.nome.length > 10
                    ? ex.nome.substring(0, 10) + "…"
                    : ex.nome,
                volume:
                  Number(ex.series || 0) *
                  Number(ex.repeticoes || 0) *
      ...
      <nav className="bottom-nav">
        ...
        <div className="bottom-nav-more-wrap">
          <button
            className={`bottom-nav-btn ${["agua", "peso", "suplementos", "dieta", "macros", "historico", "dashboard"].includes(abaPrincipal) ? "active" : ""}`}
                  ...
                  <>
                    ...
                    <div className="sexo-selector">
                      ...
                      <button
                        ...
                        onClick={() =>
                          setPerfil({ ...perfil, objetivo: "manter" })
                        }
                      >
                        ⚖️ Manter
                      </button>
                      <button
                        ...
                        onClick={() =>
                          setPerfil({ ...perfil, objetivo: "ganhar" })
                        }
                      >
                        💪 Ganhar
                      </button>
          ...
          {subAbaPerfil === "notificacoes" && (
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              {notificacoesSuportadas() && notifPermissao === "denied" && (
                ...
                >
                  ⚠️ Notificações bloqueadas. Vá nas configurações do navegador
            ...
            >
              ...
              <div className="ajuda-item">
                ...
                <div className="ajuda-body">
                  <strong>Mais</strong>
                  <p>
                    Acessa Água, Peso, Dieta, Suplementos, Macros, Passos e
                    Stats pelo menu 🗃️.
                  </p>
                </div>
              </div>
              <div className="ajuda-item">
                ...
                <div className="ajuda-body">
                  ...
                  <p>
                    ...
                    arrastando ou ocultar seções que não usa. A ordem é salva
                    automaticamente.
                  </p>
                </div>
              </div>
              ...
              <div className="ajuda-item">
                ...
                <div className="ajuda-body">
                  <strong>Hábitos personalizados</strong>
                  <p>
                    Na seção Hábitos do dia (Home), role até o final e toque em
                    "+ Adicionar hábito". Você pode criar hábitos com emoji e
                    nome personalizados além dos 6 padrões.
                  </p>
                </div>
              </div>
              ...
              <div className="ajuda-item">
                ...
                <div className="ajuda-body">
                  ...
                  <p>
                    Hormônio produzido em resposta ao estresse. Cronicamente
                    elevado causa retenção de líquido (até 2kg a mais na
                    balança), dificulta queima de gordura, prejudica o sono e
                    reduz testosterona.
                  </p>
                </div>
              </div>
              <div className="ajuda-item">
                ...
                <div className="ajuda-body">
                  ...
                  <p>
                    ...
                    equilibrada, hidratação adequada e gerenciar estresse
                    emocional.
                  </p>
                </div>
              </div>
              ...
              <div className="ajuda-item">
                ...
                <div className="ajuda-body">
                  ...
                  <p>
                    ...
                    responsável pela recuperação muscular e queima de gordura.
                    Menos de 6h aumenta cortisol, grelina (fome) e reduz leptina
                    (saciedade).
                  </p>
                </div>
              </div>
              <div className="ajuda-item">
                ...
                <div className="ajuda-body">
                  ...
                  <p>
                    Acorde sempre no mesmo horário, mesmo no fim de semana.
              ...
              <div className="ajuda-item">
                ...
                <div className="ajuda-body">
                  ...
                  <p>
                    Cada kg de músculo queima 13–20 kcal por dia em repouso.
                    Quanto mais massa muscular, mais calorias você gasta sem
                    fazer nada.
                  </p>
                </div>
              </div>
              ...
              <div className="ajuda-item">
                ...
                <div className="ajuda-body">
                  ...
                  <p>
                    ...
                    paradoxalmente ajuda a reduzir essa retenção. Comece o dia
                    com 500ml em jejum.
                  </p>
                </div>
              </div>
              ...
              <div className="ajuda-item">
                ...
                <div className="ajuda-body">
                  ...
                  <p>
                    ...
                    0,5–0,8kg/semana. Acima de 1.000 kcal de deficit queima
                    músculo e derruba o metabolismo.
                  </p>
                </div>
              </div>
              <div className="ajuda-item">
                ...
                <div className="ajuda-body">
                  ...
                  <p>
                    Na aba Macros você vê o saldo do dia: meta base + kcal do
                    treino + kcal dos passos - kcal ingeridas. Verde = deficit
              ...
              <div className="ajuda-item">
                ...
                <div className="ajuda-body">
                  ...
                  <p>
                    Na aba Dieta toque em "✨ Sugestão de dieta automática",
                    escolha seu objetivo (emagrecer, manter, ganhar massa) e
                    renda financeira (baixa, média, alta). O app gera um plano
                    alimentar completo que você pode editar depois.
                  </p>
                </div>
              </div>
              <div className="ajuda-item">
                ...
                <div className="ajuda-body">
                  ...
                  <p>
                    ...
                    "Alimentos Personalizados" e cadastre com nome, kcal,
                    proteína, carboidrato e gordura por 100g.
                  </p>
                </div>
              </div>
              ...
              <div className="ajuda-item">
                ...
                <div className="ajuda-body">
                  ...
                  <p>
                    O peso oscila 1–3kg por resíduo gástrico, hidratação e
                    sódio. Essas variações não são gordura — são fluidos.
                  </p>
                </div>
              </div>
              <div className="ajuda-item">
              ...
              <div className="ajuda-item">
                ...
                <div className="ajuda-body">
                  ...
                  <p>
                    Sempre em jejum logo após acordar, após urinar, sem roupa ou
                    com roupa leve sempre igual. Mesmo horário todo dia.
                  </p>
                </div>
              </div>
              ...
              <div className="ajuda-item">
                ...
                <div className="ajuda-body">
                  ...
                  <p>
                    Use uma fita métrica flexível encostada na pele sem apertar
                    nem folgar. Meça sempre no mesmo horário, de preferência
                    pela manhã em jejum, e sempre no mesmo lado do corpo.
                  </p>
                </div>
              </div>
              <div className="ajuda-item">
                ...
                <div className="ajuda-body">
                  ...
                  <p>
                    Braço flexionado a 90°, fita na parte mais grossa do
                    músculo.
                  </p>
                </div>
              </div>
              <div className="ajuda-item">
                ...
                <div className="ajuda-body">
                  <strong>Peito</strong>
                  <p>
                    Na altura dos mamilos, braços relaxados ao lado do corpo.
                  </p>
                </div>
              </div>
              <div className="ajuda-item">
              ...
              <div className="ajuda-item">
                ...
                <div className="ajuda-body">
                  ...
                  <p>
                    ...
                    semanas para aparecer — medir todo dia gera ansiedade sem
                    informação útil.
                  </p>
                </div>
              </div>
              ...
              <div className="ajuda-item">
                ...
                <div className="ajuda-body">
                  ...
                  <p>
                    Usa relógio ou celular que conta passos? Ao final do dia vá
                    na aba Passos (menu 🗃️) e registre quantos passos você deu.
                    Com o tempo você terá um histórico real da sua atividade
                    diária.
                  </p>
                </div>
              </div>
              <div className="ajuda-item">
                ...
                <div className="ajuda-body">
                  ...
                  <p>
                    ...
                    — equivale a aproximadamente 8km e 400 kcal. Mas qualquer
                    aumento já traz benefícios: quem sai de 3.000 para 7.000 já
              ...
              <div className="ajuda-item">
                ...
                <div className="ajuda-body">
                  ...
                  <p>
                    Cada 1.000 passos queima aproximadamente 40 kcal. 10.000
                    passos diários = ~400 kcal extras por dia.
                  </p>
                </div>
              </div>
              ...
              <div className="ajuda-item">
                ...
                <div className="ajuda-body">
                  ...
                  <p>
                    ...
                    DayForge. Registre gastos, cartão, investimentos e entradas
                    por mês.
                  </p>
                </div>
              </div>
              ...
              <div className="ajuda-item">
                ...
                <div className="ajuda-body">
                  ...
                  <p>
                    Lance suas compras no crédito separadamente para ter
                    controle do quanto gastou no cartão.
                  </p>
                </div>
              </div>
              <div className="ajuda-item">
              ...
              <div className="ajuda-item">
                ...
                <div className="ajuda-body">
                  ...
                  <p>
                    Registre tudo que entrou no mês — salário, freelas, vendas,
                    etc.
                  </p>
                </div>
              </div>
              <div className="ajuda-item">
                ...
                <div className="ajuda-body">
                  ...
                  <p>
                    Na aba Resumo você vê o balanço do mês — entradas menos
                    gastos, cartão e investimentos. Verde = positivo, vermelho =
                    negativo.
                  </p>
                </div>
              </div>
