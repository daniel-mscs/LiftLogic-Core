export const NOTIFICACOES = [
  { id: 'suplementos', hora: 8,  minuto: 0,  titulo: '💊 Suplementos',     corpo: 'Hora de tomar seus suplementos!' },
  { id: 'agua',        hora: 10, minuto: 0,  titulo: '💧 Hidratação',       corpo: 'Você já bebeu água hoje?' },
  { id: 'agua2',       hora: 14, minuto: 0,  titulo: '💧 Hidratação',       corpo: 'Não esquece da água da tarde!' },
  { id: 'treino',      hora: 17, minuto: 0,  titulo: '🏋️ Treino',           corpo: 'Bora treinar hoje?' },
  { id: 'macros',      hora: 20, minuto: 0,  titulo: '🍽️ Macros',           corpo: 'Registrou suas refeições hoje?' },
  { id: 'peso',        hora: 21, minuto: 0,  titulo: '⚖️ Peso',             corpo: 'Lembre de pesar amanhã cedo em jejum!' },
  { id: 'habitos',     hora: 22, minuto: 0,  titulo: '✅ Hábitos',          corpo: 'Completou seus hábitos hoje?' },
]
