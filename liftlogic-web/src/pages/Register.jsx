...
export default function Register({ onSwitchToLogin }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErro('Não foi possível conectar ao servidor. Verifique se o Back-end está rodando.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ textAlign: 'center', color: 'rgba(255,255,255,0.4)', fontSize: '14px', marginTop: '24px', marginBottom: 0 }}>
          Já tem conta?{' '}
